...
fn main() {
    ...
    let vertex_buffer = glium::VertexBuffer::new(&display, &[
		Vertex { position: (-0.5,-0.5,-0.5 ), normal: ( 0.0, 0.0, 0.0), tex_coord: (0.0,0.0) }, // 0
		Vertex { position: (-0.5, 0.5,-0.5 ), normal: ( 0.0, 0.0, 0.0), tex_coord: (1.0,0.0) }, // 1
		Vertex { position: ( 0.5,-0.5,-0.5 ), normal: ( 0.0, 0.0, 0.0), tex_coord: (0.0,1.0) }, // 2
		Vertex { position: ( 0.5, 0.5,-0.5 ), normal: ( 0.0, 0.0, 0.0), tex_coord: (1.0,1.0) }, // 3

		Vertex { position: (-0.5,-0.5, 0.5 ), normal: ( 0.0, 0.0, 0.0), tex_coord: (0.0,1.0) }, // 4
		Vertex { position: (-0.5, 0.5, 0.5 ), normal: ( 0.0, 0.0, 0.0), tex_coord: (1.0,1.0) }, // 5
		Vertex { position: ( 0.5,-0.5, 0.5 ), normal: ( 0.0, 0.0, 0.0), tex_coord: (0.0,0.0) }, // 6
		Vertex { position: ( 0.5, 0.5, 0.5 ), normal: ( 0.0, 0.0, 0.0), tex_coord: (1.0,0.0) }, // 7

		Vertex { position: (-0.5,-0.5, 0.5 ), normal: ( 0.0, 0.0, 0.0), tex_coord: (1.0,0.0) }, // 4' 8
		Vertex { position: (-0.5, 0.5, 0.5 ), normal: ( 0.0, 0.0, 0.0), tex_coord: (0.0,0.0) }, // 5' 9 
		Vertex { position: ( 0.5,-0.5, 0.5 ), normal: ( 0.0, 0.0, 0.0), tex_coord: (1.0,1.0) }, // 6'10
		Vertex { position: ( 0.5, 0.5, 0.5 ), normal: ( 0.0, 0.0, 0.0), tex_coord: (0.0,1.0) }, // 7'11
